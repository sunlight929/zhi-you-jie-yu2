...
def generate_yearly_trend() -> pd.DataFrame:
    ...
    # 数值与「多源数据对比」对齐：大学生 2024 ≈ 29.8%、中老年 2024 ≈ 15.3%
    # 大学生：上升轨迹（COVID 后升幅显著，符合 Gao 2020 / Luo 2021 趋势）
    student = [18.5, 19.2, 20.5, 22.1, 23.4, 25.6, 27.2, 28.1, 28.9, 29.8]
    # 中老年：平缓上升（基于 CHARLS 历年 ≥10 切点报告，15% 水平稳定）
    elderly = [10.2, 10.8, 11.3, 11.9, 12.5, 13.4, 14.0, 14.5, 14.9, 15.3]
    return pd.DataFrame({
        "年份": years,
