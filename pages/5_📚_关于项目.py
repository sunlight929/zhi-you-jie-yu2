...
#### 张小臣 副研究员 / 正高级工程师
- **单位**：天津大学医学工程与转化医学研究院
- **研究方向**：神经生物学，抑郁症、精神分裂症、焦虑症等精神类疾病发病机制；神经调控技术；特异脑电信号生物学基础
- **学术成果**：30+ SCI 论文（含 *Advanced Science*、*Neuron*、*PNAS*、*PLoS Biology*）
- **关键项目**："面向脑认知的抑郁情绪识别模型开发"（横向项目，2023.03-2024.12，项目负责人）—— 与本作品方向高度一致
- **职责**：医学专业方向把关，PHQ-9 / CES-D 量表合规性、临床建议合规性

#### 张淑芳 副教授 / 博士生导师 / 电子信息工程系主任
- **单位**：天津大学电气与自动化工程学院
- **研究方向**：人工智能与 AIGC 大模型；机器人系统及具身智能；数字图像处理与三维重建
- **学术成果**：60+ SCI 论文（含 IEEE TCSVT/TMM/RAL 等 TOP 期刊）+ 18 项授权国家发明专利
- **职责**：AI 技术方向把关，模型架构、可视化系统、Web 平台设计
